...
> *Heritage craftsmanship in the digital age — the physical, the tactile, the irreplaceable.*
...
| 7 | The Miniaturist | Paint a set of tabletop gaming miniatures to "tabletop standard" — clean base coats, washes, highlights, and based. |
| 8 | The Sound Maker | Build a functional musical instrument from scratch — cigar box guitar, kalimba, or theremin — and create a generative voice on a modular synthesizer (hardware or VCV Rack) where the music plays itself. |
| 9 | The Weaver | Produce a finished textile on a loom — floor, rigid heddle, or backstrap — using a pattern of your own design. |
| **FINAL BOSS** | **The Atelier** | **Produce a unified body of work across at least four analog disciplines — combining original visual art, sound, text, and craft — exhibited or performed as a cohesive collection.** |
